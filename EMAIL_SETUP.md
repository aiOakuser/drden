# Email Configuration Guide for designrden
...
EMAIL_PORT=587
EMAIL_USE_TLS=True
DEFAULT_FROM_EMAIL=designrden <your.email@gmail.com>
```
...
EMAIL_PORT=587
EMAIL_USE_TLS=True
DEFAULT_FROM_EMAIL=designrden <no-reply@your-domain.com>
```
...
EMAIL_PORT=587
EMAIL_USE_TLS=True
DEFAULT_FROM_EMAIL=designrden <your.email@outlook.com>
```
