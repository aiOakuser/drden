...
AGENCIES_HERO = {
    ...
    "lead": (
        "GlobalDesignerHub (GDH) is the operating layer for fashion and creative agencies — "
...
AGENCIES_FEATURE_GROUPS = (
    ...
    },
    {
        ...
        "summary": "Activate GDH audiences for campaigns, education, and long-term brand building.",
        "features": (
            {
                "icon": "fa-comments",
