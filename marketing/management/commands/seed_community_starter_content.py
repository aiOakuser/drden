...
STARTER_EVENTS = [
    {
        ...
        "summary": "Live teardown of three GDH portfolios — what's working, what's hiding, what to fix this week.",
        "description_html": (
            "<p>Bring your portfolio link or just lurk. We'll review three "
            "real GDH portfolios on screen — covering hierarchy of work, "
        ...
        "host_name": "GDH editorial",
        "host_bio": (
            "GDH's editorial team curates Emerging Talent features and reviews "
    ...
    },
    {
        ...
        "description_html": (
            ...
            "<p>We'll use GDH's tech-pack templates so you walk away with "
        ...
        "host_bio": (
            ...
            "European womenswear brands and teaches tech-pack craft at GDH."
        ),
        "is_virtual": True,
        "location": "Zoom",
        "capacity": 60,
    },
    {
        ...
        "summary": "Four hours, one brief, the GDH community. Pitch, design and submit a denim look in real time.",
        "description_html": (
            "<p>A live design jam: we drop a brief at the top of the hour, "
            "you have four hours to design a denim look (sketch, fabric "
            "story, BOM), and submit at the end. The GDH editorial team "
...
STARTER_FEATURES = [
    {
        ...
        "success_story_html": (
            "<p>Two weeks after her GDH portfolio went live, Maya was invited "
    ...
    },
    {
        ...
        "success_story_html": (
            ...
            "drops next quarter. Ren credits GDH's brand-partnership pipeline "
...
class Command(BaseCommand):
    help = (
        "Seed (or refresh) the GDH community feature pack with starter "
