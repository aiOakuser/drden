...
def _default_forum_url() -> str:
    value = os.getenv("COMMUNITY_FORUM_URL", "https://designrden.com/community").strip()
    return value or "https://designrden.com/community"

COMMUNITY_FORUM_URL = _default_forum_url()

def _default_ios_app_name() -> str:
    value = os.getenv("IOS_APP_NAME", "designrden").strip()
    return value or "designrden"
...
def _default_drden_instagram_url() -> str:
    value = (os.getenv("drden_INSTAGRAM_URL") or os.getenv("INSTAGRAM_PROFILE_URL") or "").strip()
    if value:
        return value
    return "https://www.instagram.com/designrden/"


drden_INSTAGRAM_URL = _default_drden_instagram_url()
...
if USE_S3_MEDIA:
    ...
    STORAGES = {
        "default": {"BACKEND": "drden.storages.MediaStorage"},
        "designers_accounts": {"BACKEND": "drden.storages.DesignersAccountsStorage"},
        "viewers_accounts": {"BACKEND": "drden.storages.ViewersAccountsStorage"},
        "techpacks": {"BACKEND": "drden.storages.TechpacksStorage"},
        "orders": {"BACKEND": "drden.storages.OrdersStorage"},
        "events": {"BACKEND": "drden.storages.EventsStorage"},
        "collections": {"BACKEND": "drden.storages.CollectionsStorage"},
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "designer_portfolio.context_processors.drden_instagram_url",
...
WSGI_APPLICATION = "drden.wsgi.application"
...
if _configured_from:
    ...
    DEFAULT_FROM_EMAIL = f"designrden <{EMAIL_HOST_USER}>"
else:
    DEFAULT_FROM_EMAIL = "designrden <no-reply@designrden.com>"
SERVER_EMAIL = DEFAULT_FROM_EMAIL
ADMIN_EMAIL = "admin@designrden.com"
...
SOCIAL_AUTH_STRATEGY = "drden.social_strategy.CanonicalDjangoStrategy"
...
WEBAUTHN_RP_NAME = os.getenv("WEBAUTHN_RP_NAME", "designrden Designer")
...
# --- Google Reviews ---
# URL where users can write a Google review for designrden.
