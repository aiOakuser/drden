...
def _drden_instagram_profile_url() -> str:
    """Canonical drden Instagram link (settings.drden_INSTAGRAM_URL)."""
    return (getattr(settings, "drden_INSTAGRAM_URL", None) or "").strip()
...
def _build_permalink(shortcode: str | None) -> str:
    ...
    return _drden_instagram_profile_url()
...
class HomePageView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        forum_url = getattr(
            settings,
            "COMMUNITY_FORUM_URL",
            "https://community.designrden.com",
        )
        ...
        context["global_designer_features"] = [
            ...
            },
            {
                ...
                "description": (
                    ...
                    "Designer AI assistant tuned for designrden workflows."
                ),
                "bullets": [
            ...
            },
            {
                ...
                "description": (
                    ...
                    "inside threads with the designrden community."
                ),
                "bullets": [
...
class IPhoneAppDownloadView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        app_name = getattr(settings, "IOS_APP_NAME", "designrden").strip() or "designrden"
...
def contact_view(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            subject = f"[designrden] Contact request: {data['subject']}"
            body = (
                "A new contact form submission was received on designrden.com/contact\n\n"
                f"Name: {data['name']}\n"
                f"Email: {data['email']}\n"
            ...
            email = EmailMessage(
                subject=subject,
                body=body,
                from_email=getattr(settings, "DEFAULT_FROM_EMAIL", "no-reply@designrden.com"),
                to=[contact_email],
                reply_to=[data["email"]],
            )
            try:
...
def students_landing_view(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            data = form.cleaned_data
            subject = "[designrden] Student invite request"
            body = (
                "New student invite request from designrden.com/students\n\n"
                f"Name: {data['name']}\n"
                f"Email: {data['email']}\n"
...
class PrivacyPolicyView(designrdenLegalPageView):
    template_name = "designer_portfolio/privacy_policy.html"


class TermsOfServiceView(designrdenLegalPageView):
    template_name = "designer_portfolio/terms_of_service.html"


class RefundPolicyView(designrdenLegalPageView):
    template_name = "designer_portfolio/refund_policy.html"


class GrievancePolicyView(designrdenLegalPageView):
    template_name = "designer_portfolio/grievance_policy.html"


class DataRightsPolicyView(designrdenLegalPageView):
    template_name = "designer_portfolio/data_rights_policy.html"


class AccessibilityStatementView(designrdenLegalPageView):
    template_name = "designer_portfolio/accessibility_statement.html"


class SecurityPolicyView(designrdenLegalPageView):
...
class CommunityForumView(TemplateView):
    ...
    FAQ_ENTRIES = [
        {
            "question": "Who can join the designrden Community Forum?",
            "answer": (
                "Every active designer account automatically gains forum access with the same "
                "designrden credentials. If your portfolio is still pending approval, you can browse "
        ...
        },
        {
            ...
            "answer": (
                ...
                "designrden email or send a one-time guest link that expires in 7 days. Guests can comment, "
        ...
        },
        {
            ...
            "answer": (
                "All paid and trial designrden subscriptions include full forum participation. If your "
        ...
        },
        {
            ...
            "answer": (
                ...
                "concerns, email support@designrden.com with links to the affected threads. We maintain a "
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form_type == "attendee":
            if not request.user.is_authenticated:
                messages.error(
                    request,
                    "Please sign in to RSVP. Only registered designrden users can register for shows.",
                )
        ...
        context.update(
            {
                ...
                "instagram_profile_url": _drden_instagram_profile_url(),
...
def _build_infrastructure_response() -> str:
    """Generate a reusable explanation of drden infrastructure details."""
    canonical_host = getattr(settings, "CANONICAL_HOST", "designrden.com")
...
Need more help? See: (/docs/designers/media-guidelines)"""
        ...
        "profile": {
            ...
            "response": """Setting up your designrden profile is easy:
...
Learn more: (/docs/designers/getting-started)"""
        ...
        "api": {
            ...
            "response": """designrden offers a REST API for integrations:
...
**Embedding:**
You can embed your drden portfolio on your own website using our embed widgets.
...
For developers: (/docs/api/overview)"""
        ...
        "default": {
            "response": """I'm here to help with design portfolios and designrden!

I can assist with:
- Portfolio structure and layouts
- Uploading and organizing your work
- Using drden features
...
designrden has an accessibility statement: (/policies/accessibility)
...
- Cross-post to your designrden profile
