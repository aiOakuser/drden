...
| `BASE_URL_SERVER` | `https://globaldesignerhub.com` | Canonical public URL |
| `ALLOWED_HOSTS` | `globaldesignerhub.com,www.globaldesignerhub.com` | Comma-separated |
| `CSRF_TRUSTED_ORIGINS` | `https://globaldesignerhub.com,https://www.globaldesignerhub.com` | Must include scheme |
...
DEFAULT_FROM_EMAIL=GlobalDesignerHub <noreply@yourdomain.com>
```
